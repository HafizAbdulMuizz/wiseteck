...
/*
  ...
  LAYOUT RULE (matches About page pattern exactly):
  - site-container > max-w-3xl  →  section header only (badge + h2 + tagline + intro)
  - site-container > [no inner max-w]  →  sub-block cards span full container width
  This produces the same horizontal boundaries as the Homepage and About page.
*/
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white text-[#4F5B6A]">
      ...
      <main className="flex-1">
        ...
        {/* Layout: site-container → max-w-3xl header, then full-width sub-blocks     */}
        {/* ========================================================================= */}
        <section id="support-hub" className="section-padding bg-white border-b border-[#E2E8F0]">
          <div className="site-container">

            {/* Section Header — max-w-3xl matches About page section header pattern */}
            <div className="max-w-3xl mb-8">
              ...
              <div className="p-4 rounded-xl bg-[#F8FAFC] border-l-4 border-[#0B1F3A] border-y border-r border-[#E2E8F0] mb-6">
              ...
              <div className="space-y-4 text-base text-[#4F5B6A] leading-relaxed [text-wrap:pretty]">
                <p>
            ...
            {/* Sub-blocks — full container width, no max-w wrapper (matches About card grid pattern) */}
            <div className="space-y-6">
              ...
              <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-2xl p-8 sm:p-10">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-3 mb-6 text-sm font-semibold text-[#0B1F3A]">
                  {[
                    "Free ICS Education",
                    "Free Books",
                    "Free Stationery",
              ...
              {/* Sub-block B & C — side by side on desktop, stacked on mobile */}
        ...
        <section id="educational-hub" className="section-padding bg-[#F8FAFC] border-b border-[#E2E8F0]">
          <div className="site-container">
            ...
            <div className="max-w-3xl mb-8">
              ...
              <div className="p-4 rounded-xl bg-white border-l-4 border-[#5F2DEE] border-y border-r border-[#E2E8F0] mb-6">
                <p className="text-sm sm:text-base font-bold text-[#0B1F3A]">
            ...
            {/* Sub-blocks — full container width */}
            <div className="space-y-6">

              {/* Sub-block A: ADP Programs */}
              <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 sm:p-10">
                ...
                <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mb-6 text-sm font-semibold text-[#0B1F3A]">
                  {[
              ...
              {/* Sub-block B & C — side by side on desktop */}
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="bg-white border border-[#E2E8F0] rounded-2xl p-8 sm:p-10">
                  <h3 className="text-xl font-bold text-[#0B1F3A] mb-4">
          ...
          <div className="site-container">
            ...
            <div className="max-w-3xl mb-8">
              <div className="flex items-center justify-between gap-4 mb-4">
                ...
                {/* Official NAVTTC Accreditation Badge — original logo, original colors */}
              ...
              <div className="p-4 rounded-xl bg-[#F8FAFC] border-l-4 border-[#163259] border-y border-r border-[#E2E8F0] mb-6">
                <p className="text-sm sm:text-base font-bold text-[#0B1F3A]">
            ...
            {/* Sub-blocks — full container width, side by side on desktop */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <section id="incubation-platform" className="section-padding bg-[#0B1F3A] text-white relative">
          <div className="site-container">
            ...
            <div className="max-w-3xl mb-8">
              ...
              <h2 className="text-3xl sm:text-4xl lg:text-[42px] font-bold text-white leading-tight mb-0 [text-wrap:balance]">
                WISE-Teck Incubation Platform
              </h2>
            </div>

            {/* Sub-blocks A & B — side by side on desktop, full container width */}
            ...
            {/* Sub-block C: The Ecosystem Journey — full container width */}
            <div className="bg-white/10 border-2 border-[#FFB347]/40 rounded-3xl p-8 sm:p-10 lg:p-12 shadow-lg">
              ...
              {/* Desktop: Flowing Linear Journey (7 Steps) */}
              ...
              {/* Mobile & Tablet: Stacked Sequence */}
